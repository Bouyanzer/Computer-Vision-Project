...
from Fine_Tunning_VGG19_Function import Binary_VGG19_FineTunning
...
#**************************************************************************
print("\n\t[INFO] VGG19_FineTunning...")
MyModel=Binary_VGG19_FineTunning(input_shape,optimizer,ClassificationType,lossV,NbClass)
MyModel.summary()
#**************************************************************************
...
mc = ModelCheckpoint('Model/VGG19_FT.h5', monitor='val_accuracy', mode='max', verbose=1, save_best_only=True)
...
SaveHistory(history,'VGG19_FT_')
PlotFigures(history,MyModel,'VGG19_FT_')
validation_steps = (test_set.classes.shape[0]//batch_size+1)#+1 Obligatoire pour la matrice de confusion
ConfutionMatrix_ClassificationReport(MyModel,'VGG19_FT_',test_set,validation_steps)
