...
from Fine_Tunning_InceptionResnet_Function import Binary_InceptionResnet_FineTunning
...
#**************************************************************************
print("\n\t[INFO] InceptionResnet_FineTunning...")
MyModel=Binary_InceptionResnet_FineTunning(input_shape,optimizer,ClassificationType,lossV,NbClass)
MyModel.summary()
#**************************************************************************
...
mc = ModelCheckpoint('Model/IncepResNet_FT.h5', monitor='val_accuracy', mode='max', verbose=1, save_best_only=True)
...
#Fine Tuning
#Fine Tuning
# pre_trained_modelLayers[617].name
# for layer in pre_trained_modelLayers[618:]:
...
SaveHistory(history,'IncepResNet_FT_')
PlotFigures(history,MyModel,'IncepResNet_FT_')
validation_steps = (test_set.classes.shape[0]//batch_size+1)#+1 Obligatoire pour la matrice de confusion
ConfutionMatrix_ClassificationReport(MyModel,'IncepResNet_FT_',test_set,validation_steps)
